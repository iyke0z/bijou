        ...
        <card>
          <template slot="header">
            ...
            <p class="card-category">Handcrafted by our friend
              <a target="_blank" href="https://github.com/binarcode">BinarCode</a>. Please checkout the
              <a href="https://github.com/binarcode/vue-notifyjs" target="_blank">full documentation.</a>
            </p>
          </template>
          <div class="row">
            <div class="col-md-6">
          ...
          <div class="places-buttons">
            ...
            <div class="row">
              <div class="col-lg-8 ml-auto mr-auto">
                <div class="row">
                  <div class="col-md-4">
                    <p-button type="default" outline block round @click.prevent="notifyVue('top','left')">Top Left</p-button>
                  </div>
                  <div class="col-md-4">
                    <p-button type="default" outline block round @click.prevent="notifyVue('top','center')">Top Center
                    </p-button>
                  </div>
                  <div class="col-md-4">
                    <p-button type="default" outline block round @click.prevent="notifyVue('top','right')">Top Right</p-button>
                  </div>
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-lg-8 ml-auto mr-auto">
                <div class="row">
                  <div class="col-md-4">
                    <p-button type="default" outline block round @click.prevent="notifyVue('bottom','left')">Bottom Left</p-button>
                  </div>
                  <div class="col-md-4">
                    <p-button type="default" outline block round @click.prevent="notifyVue('bottom','center')">Bottom Center
                    </p-button>
                  </div>
                  <div class="col-md-4">
                    <p-button type="default" outline block round @click.prevent="notifyVue('bottom','right')">Bottom Right</p-button>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="row">
            <div class="col-md-12 text-center">
                ...
                <template>
                  <div class="instruction">
                    <div class="row">
                      ...
                      <div class="col-md-4">
                        <div class="picture">
                          <img src="static/img/background/daniel-olahs.jpg" alt="Thumbnail Image" class="rounded img-raised">
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="instruction">
                    <div class="row">
                      ...
                      <div class="col-md-4">
                        <div class="picture">
                          <img src="static/img/background/david-marcu.jpg" alt="Thumbnail Image" class="rounded img-raised">
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <modal :show.sync="modals.mini"
                ...
                <template slot="footer">
                  <div class="left-side">
                    <p-button type="default" link @click.prevent="modals.mini = false">Back</p-button>
                  </div>
                  <div class="divider"></div>
                  <div class="right-side">
                    <p-button type="default" link @click.prevent="modals.mini = false">Close</p-button>
                  </div>
                </template>
              </modal>
