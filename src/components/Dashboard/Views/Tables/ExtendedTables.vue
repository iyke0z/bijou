          ...
          <el-table :data="tableData" header-row-class-name="text-primary">
            ...
            <el-table-column
              ...
              <template slot-scope="props">
                <p-button type="info" size="sm" icon @click.prevent="handleLike(props.$index, props.row)">
                  <i class="fa fa-user"></i>
                </p-button>
                <p-button type="success" size="sm" icon @click.prevent="handleEdit(props.$index, props.row)">
                  <i class="fa fa-edit"></i>
                </p-button>
                <p-button type="danger" size="sm" icon @click.prevent="handleDelete(props.$index, props.row)">
              ...
              <el-table-column
                ...
                <template slot-scope="props">
                  ...
                  <div class="btn-group btn-group-sm">
                    <p-button type="default" round outline size="sm" @click.prevent="props.row.quantity > 0 ? props.row.quantity-- : 0">
                      <i class="nc-icon nc-simple-delete"></i>
                    </p-button>
                    <p-button type="default" round outline size="sm" @click.prevent="props.row.quantity++">
