      ...
      <div class="paper">
        ...
        <div class="body">
          ...
          <div class="customerDetails" v-if="customer != null">
            ...
            <div class="row">
                <div class="col-8"><span class="mr-8"><b>INVOICE NUMBER:</b></span>INVOICE_NO-{{ summary.ref_no || 'N/A' }}</div>
            </div>
          </div>
        ...
        <div class="footnote mt-5">
          <center>
            <small>
              <p>{{ numberToWords(Math.ceil(summary.total + parseFloat(summary?.logistics))) }} naira only</p>
              <p><i>Thank you for your business! Please remit payment via cash or transfer.</i></p>
              <b>{{ details }}</b>
            </small>
          </center>
        </div>
...
downloadPDF() {
  ...
  const opt = {
    margin:       0.5,
    filename:     `INV-${this.ref_no || 'receipt'}.pdf`,
