  ...
  export default {
    ...
    props: {
      type: {
        ...
        default: '',
        validator: (value) => {
          let acceptedValues = ['', 'primary', 'info', 'success', 'warning', 'danger', 'armyred', 'armygreen']
          return acceptedValues.indexOf(value) !== -1
        },
        description: 'Tabs type (primary|info|danger|default|warning|success|armyred|armygreen)'
      },
      pills: {
        type: Boolean,
